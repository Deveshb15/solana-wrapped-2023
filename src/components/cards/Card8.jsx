      ...
      >
        ...
        <div className="ml-12 md:mt-[72px] md:flex font-dm absolute z-10 w-[312px] h-[484px] md:w-[670px] md:h-[391px]]">
          ...
          <div className='flex flex-col'>
            <div className="mt-12 rounded-lg md:w-36 md:h-16 justify-center text-center" style={{
            ...
            <div className="mt-2 rounded-lg md:w-36 md:h-16 justify-center text-center" style={{
            background: 'rgba(37, 43, 53, 0.30)',
            }}>
                    <p className="text-white mt-3 flex justify-center md:text-lg leading-[38.40px]">
          ...
          <div className="mt-12 ml-2 rounded-lg md:w-36 md:h-36 justify-center text-center" style={{
            background: 'rgba(37, 43, 53, 0.30)'
            }}>
          ...
          <div className="mt-2 ml-1 rounded-lg md:w-72 md:h-36 justify-center text-center" style={{
            background: 'rgba(37, 43, 53, 0.30)',
            }}>
                    <p className="text-white pt-6 flex justify-center md:text-lg leading-[38.40px]">
                    2,000$                    </p>
          ...
          <div>
          <div className="mt-12 ml-5 rounded-lg md:w-72 md:h-36 flex flex-col justify-center text-center" style={{
            background: 'rgba(37, 43, 53, 0.30)',
            }}>
          ...
          <div className='flex ml-5 flex-row'>
            ...
            background: 'rgba(37, 43, 53, 0.30)',
                    ...
                    <p className='text-fade text-[8px]'>Increase in Wallet Balance</p>
